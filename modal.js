...
let conditionsSelectaff = document.querySelector("#Conditions  #checkbox1");
...
function checkValidationsForm(e) {
  ...
  if (failedInputs.length) {
    ...
    let SaisieIncomplete6 = document.querySelector("#myOption");
    SaisieIncomplete6.style.opacity = 0;
    let SaisieIncomplete7 = document.querySelector("#Conditions");
    SaisieIncomplete7.style.opacity = 0;
    btnFermer.classList.remove("nonActif");
    let effTextLabel = document.querySelector(".text-label");
    effTextLabel.style.opacity = 0;

    // let  affichageMerciInscription = document.querySelector('#affMercii');
...
function boolNom(e) {
  let inputPrenomDiv = document.querySelector(".formData:nth-child(2) div");
  // regex 2 lettres alphabétiques et 2 caractères minimuns
...
function boolEmail(e) {
  // let  inputEmail = document.querySelector('.formData:nth-child(3)');
...
function boolDate(e) {
  let date = document.querySelector(".formData:nth-child(4) input ");

  const regexDate = /^\d{4}\-(0[1-9]|1[012])\-(0[1-9]|[12][0-9]|3[01])$/;

  let annee = e.target.value.substr(0, 4);
...
function boolQuantite(e) {
  // let  inputQuantite = document.querySelector('#myQuantity');
  if (e.target.value === "") {
...
function boolOption() {
  let boutonSelect = document.querySelectorAll("#myOption  input");
  for (let i = 0; i < boutonSelect.length; i++) {
...
function boolConditions() {
  let inputConditions = document.querySelector("#Conditions ");
  let conditionsSelect = document.querySelector("#Conditions  #checkbox1");
